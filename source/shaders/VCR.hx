...
class VCR extends flixel.system.FlxAssets.FlxShader
{
    // definitely taken from https://github.com/nebulazorua/andromeda-engine/blob/master/source/Shaders.hx
    // if you don't want this here, tell me
	...
	public function new()
	{
        ...
        this.iTime.value = [0];
        this.vignetteOn.value = [true];
        this.perspectiveOn.value = [true];
        this.distortionOn.value = [false];
        this.scanlinesOn.value = [false];
