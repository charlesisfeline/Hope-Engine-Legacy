	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'mic':
				...
				animation.addByPrefix('firstDeath', "mic dies", 24, false);
				animation.addByPrefix('deathLoop', "mic dies0055", 24, true);
				animation.addByPrefix('deathConfirm', "mic dies0055", 24, false);
				animation.play('firstDeath');
