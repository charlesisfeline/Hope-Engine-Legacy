    ...
    var categories:Array<OptionCategory> = [
        new OptionCategory("Preferences", [
            ...
            */
            ...
            #if FILESYSTEM
            new ValueOptionInt("FPS Cap", "The maximum FPS the game can have", "fpsCap", Application.current.window.displayMode.refreshRate, 290, 1, 10, function () { (cast (Lib.current.getChildAt(0), Main)).setFPSCap(Settings.fpsCap); }, 60, " FPS"),
            #end
            ...
            new PressOption("Change Rating and Combo positions", "Change where YOU see the rating and combo count.", function() {
            ...
            new SelectionOption("Bar Type", "What should the song position bar show?", "posBarType", ["Name & Time Elapsed", "Name & Time Left", "Name", "Time Elapsed", "Time Left", "Nothing", "Disabled"])
        ]),
        ...
        new OptionCategory("Other", [
            ...
            #end
            new ToggleOption("Pause Countdown", "If checked, there will be a countdown when you resume to gameplay.", "resumeCountdown"),
            ...
            new PressOption("Reset Options", "Reset ALL options.\n(Prompted, be careful!)", function() {
                ...
                ConfirmationPrompt.titleText = 'HEYYY!';
                ConfirmationPrompt.descText = 'Are you sure you want to RESET OPTIONS?'
